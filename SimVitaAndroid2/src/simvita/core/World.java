...
public class World {
	...
	// ----------------------------------------------------------
	/**
	 * Helper method to test that a creature is present at a given position
	 * @return true if there's a creature
	 */
	...
	// ----------------------------------------------------------
	/**
	 * Helper method to test that a creature is not present.
	 * @return true if no creature is present.
	 */
